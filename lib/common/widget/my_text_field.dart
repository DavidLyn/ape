    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            _isShowDelete ? SizedBox.shrink() : Semantics(
              label: '清空',
              hint: '清空输入框',
              child: GestureDetector(
                child: LoadedAssetImageWidget('login/clean_up_text',
            ...
            !widget.isInputPwd ? SizedBox.shrink() : SizedBox(width: 15),
            !widget.isInputPwd ? SizedBox.shrink() : Semantics(
              label: '密码可见开关',
              hint: '密码是否可见',
              child: GestureDetector(
                child: LoadedAssetImageWidget(
                  _isShowPwd ? 'login/show_password' : 'login/hide_password',
            ...
            widget.getVCode == null ? SizedBox.shrink() : SizedBox(width: 15),
            widget.getVCode == null ? SizedBox.shrink() :
            Theme(
